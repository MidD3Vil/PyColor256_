...
dic_color = [
    light_red, light_red, red, red, light_yellow, light_yellow, yellow, yellow, green, green, light_green, light_green,
    light_blue, light_blue, blue, blue, cyan, cyan,
    light_cyan, light_cyan, light_magenta, light_magenta,
    magenta, magenta, light_red, light_red, red, red, light_yellow, light_yellow, yellow, yellow, green, green, light_green, light_green,
    light_blue, light_blue, blue, blue, cyan, cyan,
    light_cyan, light_cyan, light_magenta, light_magenta,
    magenta, magenta, light_red, light_red, red, red, light_yellow, light_yellow, yellow, yellow, green, green, light_green, light_green,
    light_blue, light_blue, blue, blue, cyan, cyan,
...
txt = pyfiglet.figlet_format(f"{word}", font="doh")
